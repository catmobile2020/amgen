...
class SurveyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/survey/'.$survey->id.'/answers/create')->with('status', 'Your Question has been created .. add answers!');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Question $survey)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Question $survey)
    {
        $this->validate($request, [
            'title'=>'required|string',
        ], [
