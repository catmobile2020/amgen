                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example dataTable updateTableDataReal" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
    ...
    channel_team.bind('App\\Events\\AnswerEvent', function(data) {
        $.ajax({
            success:function (result) {
                $('.updateTableDataReal').html(result);
            }
        });
    });
</script>
